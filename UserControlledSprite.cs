...
namespace TSAUMDHG
{
    class UserControlledSprite: Sprite
    {
        ...
        public TowerSprite currentTower { get; set; }
        ...
        public void Deactivate()
        {
            ...
            if (currentTower != null)
            {
                currentTower.color.A = (byte)0;
            }
        }

        public void TowerActiveate(Vector2 position, Point frameSize)
        {
            towerActive = true;
        ...
        public void Update(GameTime gameTime, Rectangle clientBounds, List<MapSprite> pathList)
        {
            ...
            if (currentTower != null)
            {
                currentTower.SetPosition(base.position);
            }
        ...
        public void SetRange(TowerSprite tower)
        {
            this.currentTower = tower;
            SetRangeSprite(currentTower.rangeTexture, tower.range);
        }

        public void DrawRangeTower(GameTime gameTime, SpriteBatch spriteBatch)
        {
            if (currentTower != null)
            {
                currentTower.Draw(gameTime, spriteBatch);
            }
        }
